                ...
                try:
                    ...
                    st.markdown(
                            ...
                            <div class="card">
                                ...
                                <p class="card-text" style="font-size: 20px">P/L</p>
                                <p class="card-text" style="font-weight: bold; font-size: 40px">{fundamentus['P/L'][0]}</p>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-body text-center">
                                <p class="card-text" style="font-size: 20px;">P/VP</p>
                                <p class="card-text" style="font-weight: bold; font-size: 40px;">{fundamentus['P/VP'][0]}</p>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-body text-center">
                                <p class="card-text" style="font-size: 20px; ">Recomendação</p>
                                <p class="card-text" style="font-weight: bold; font-size: 40px; ">{info['recommendationKey']}</p>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-body text-center">
                                <p class="card-text" style="font-size: 20px;">Próximo dividendo</p>
                                <p class="card-text" style="font-weight: bold; font-size: 20px;">{pfizer.calendar.transpose()['Earnings Date'].dt.strftime('%d/%m/%Y')[0]}</p>
                                </div>
                            </div>
                            </div>
                            """,unsafe_allow_html=True
